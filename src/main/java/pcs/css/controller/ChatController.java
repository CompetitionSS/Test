...
public class ChatController {
    ...
    private static String secretKey = "Um5uTGtxemZuUUNiUlJyVW9FZkdtU0V1cUZEY3VyelM=" ;
    private static String apiUrl = "https://sft62bcgwa.apigw.ntruss.com/chatbot/chatbot/";
