...
<%
    NoticeQnaDTO rDTO = (NoticeQnaDTO) request.getAttribute("rDTO");
...
<head>
    ...
    <script type="text/javascript">
        ...
        function doEdit() {
            if ("<%=edit%>" == 2) {
                location.href = "/notice/NoticeQnaEditInfo?nSeq=<%=CmmUtil.nvl(rDTO.getNotice_seq())%>";
        ...
        function doDelete() {
            if ("<%=edit%>" == 2) {
                if (confirm("작성한 글을 삭제하시겠습니까?")) {
                    location.href = "/noticeQna/NoticeQnaDelete?nSeq=<%=CmmUtil.nvl(rDTO.getNotice_seq())%>";
        ...
        //목록으로 이동
        function doList() {
            location.href = "/noticeQna/NoticeQnaList";
